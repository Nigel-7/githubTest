...
#--------------------
import ast
def _plot_defo_mode_2d_Chen(fileName, incr_num, modeNo, sfac, nep, unDefoFlag, fmt_defo, fmt_undefo,
                       interpFlag, endDispFlag, fmt_interp, fmt_nodes):

    #    global Node_Disp_df
    Node_Disp_df = pd.read_csv(fileName)
    
    string="Node_Disp_df['incr_%d']" %incr_num # Node disp for this increment
    Node_Disp_thisIncr=eval(string)
    ...
    for i, ele_tag in enumerate(ele_tags):
        ...
        if nen == 2:
            ...
            # beam/frame element plot_defo
                ...
                # --------------------
                # modified by CHEN WANG
                # --------------------
                index_nd1=node_tags.index(nd1)
                index_nd2=node_tags.index(nd2)
                # --------------------
                ...
                if modeNo:
                    ...
                    ed = np.array([ast.literal_eval(Node_Disp_thisIncr[index_nd1])[0],
                                   ast.literal_eval(Node_Disp_thisIncr[index_nd1])[1],
                                   ast.literal_eval(Node_Disp_thisIncr[index_nd1])[2],
                                   ast.literal_eval(Node_Disp_thisIncr[index_nd2])[0],
                                   ast.literal_eval(Node_Disp_thisIncr[index_nd2])[1],
                                   ast.literal_eval(Node_Disp_thisIncr[index_nd2])[2]])
...
def _plot_defo_mode_3d_Chen(fileName, incr_num, modeNo, sfac, nep, unDefoFlag, fmt_defo, fmt_undefo,
                       interpFlag, endDispFlag, fmt_interp, fmt_nodes, az_el,
                       fig_wi_he, fig_lbrt):
...
#    string="Node_Disp_thisIncr=Node_Disp_df['incr_%d']" %incr_num # Node disp for this increment
#    exec(string)
...
##    ast.literal_eval(string)
    ...
    for i, ele_tag in enumerate(ele_tags):
        nen=np.shape(ops.eleNodes(ele_tag))[0]
        if nen == 2:
            if ops.eleResponse(ele_tag, 'xlocal'): # to exclude truss elements, because no eleResponse(ele_tag, 'xlocal') exist for truss

                #ndf = np.shape(ops.nodeDOFs(ops.eleNodes(ele_tag)[0]))[0]
                ndf = 6
                ...
                if ndf == 6:
                    ...
                    if modeNo:
                        ...
                        ed = np.array([ast.literal_eval(Node_Disp_thisIncr[index_nd1])[0],
                                       ast.literal_eval(Node_Disp_thisIncr[index_nd1])[1],
                                       ast.literal_eval(Node_Disp_thisIncr[index_nd1])[2],
                                       ast.literal_eval(Node_Disp_thisIncr[index_nd1])[3],
                                       ast.literal_eval(Node_Disp_thisIncr[index_nd1])[4],
                                       ast.literal_eval(Node_Disp_thisIncr[index_nd1])[5],
                                       ast.literal_eval(Node_Disp_thisIncr[index_nd2])[0],
                                       ast.literal_eval(Node_Disp_thisIncr[index_nd2])[1],
                                       ast.literal_eval(Node_Disp_thisIncr[index_nd2])[2],
                                       ast.literal_eval(Node_Disp_thisIncr[index_nd2])[3],
                                       ast.literal_eval(Node_Disp_thisIncr[index_nd2])[4],
                                       ast.literal_eval(Node_Disp_thisIncr[index_nd2])[5]])
        ...
        # plot: quad in 3d
            ...
            if ndf == 6:
                ...
                index_nd1=node_tags.index(nd1)
                index_nd2=node_tags.index(nd2)
                index_nd3=node_tags.index(nd3)
                index_nd4=node_tags.index(nd4)
                # --------------------


                # element node1-node4, x,  y coordinates
                ex = np.array([ops.nodeCoord(nd1)[0],
                               ops.nodeCoord(nd2)[0],
                               ops.nodeCoord(nd3)[0],
                               ops.nodeCoord(nd4)[0]])
                ...
                if modeNo:
                    ...
                    ed = np.array([ast.literal_eval(Node_Disp_thisIncr[index_nd1])[0],
                                   ...
                                   ast.literal_eval(Node_Disp_thisIncr[index_nd2])[1],
                                   ast.literal_eval(Node_Disp_thisIncr[index_nd2])[2],
                                   ast.literal_eval(Node_Disp_thisIncr[index_nd3])[0],
                                   ast.literal_eval(Node_Disp_thisIncr[index_nd3])[1],
                                   ast.literal_eval(Node_Disp_thisIncr[index_nd3])[2],
                                   ast.literal_eval(Node_Disp_thisIncr[index_nd4])[0],
                                   ast.literal_eval(Node_Disp_thisIncr[index_nd4])[1],
                                   ast.literal_eval(Node_Disp_thisIncr[index_nd4])[2]])
        ...
        # 8-node brick, 3d model
            ...
            index_nd3=node_tags.index(nd3)
            index_nd4=node_tags.index(nd4)
            index_nd5=node_tags.index(nd5)
            index_nd6=node_tags.index(nd6)
            index_nd7=node_tags.index(nd7)
            index_nd8=node_tags.index(nd8)
            ...
            if modeNo:
                ...
                ed = np.array([ast.literal_eval(Node_Disp_thisIncr[index_nd1])[0],
                               ...
                               ast.literal_eval(Node_Disp_thisIncr[index_nd4])[1],
                               ast.literal_eval(Node_Disp_thisIncr[index_nd4])[2],
                               ast.literal_eval(Node_Disp_thisIncr[index_nd5])[0],
                               ast.literal_eval(Node_Disp_thisIncr[index_nd5])[1],
                               ast.literal_eval(Node_Disp_thisIncr[index_nd5])[2],
                               ast.literal_eval(Node_Disp_thisIncr[index_nd6])[0],
                               ast.literal_eval(Node_Disp_thisIncr[index_nd6])[1],
                               ast.literal_eval(Node_Disp_thisIncr[index_nd6])[2],
                               ast.literal_eval(Node_Disp_thisIncr[index_nd7])[0],
                               ast.literal_eval(Node_Disp_thisIncr[index_nd7])[1],
                               ast.literal_eval(Node_Disp_thisIncr[index_nd7])[2],
                               ast.literal_eval(Node_Disp_thisIncr[index_nd8])[0],
                               ast.literal_eval(Node_Disp_thisIncr[index_nd8])[1],
                               ast.literal_eval(Node_Disp_thisIncr[index_nd8])[2]])
...
def _plot_defo_mode_3d_Chen_2(specifyEle, fileName, incr_num, modeNo, sfac, nep, unDefoFlag, fmt_defo, fmt_undefo,
                       interpFlag, endDispFlag, fmt_interp, fmt_nodes, az_el,
                       fig_wi_he, fig_lbrt):
...
def plot_defo(fileName, incr_num,  sfac=False, nep=17, unDefoFlag=1, fmt_defo=fmt_defo,
...
This usually happens when translational DOFs are too small\n\n""")
        ...
        _plot_defo_mode_2d_Chen(fileName, incr_num, 0, sfac, nep, unDefoFlag, fmt_defo, fmt_undefo,
        ...
        _plot_defo_mode_3d_Chen(fileName, incr_num, 0, sfac, nep, unDefoFlag, fmt_defo, fmt_undefo,
                           interpFlag, endDispFlag, fmt_interp,
...
def plot_defo_chen(fileName, incr_num, sfac=False, specifyEle=[], nep=17, unDefoFlag=1, fmt_defo=fmt_defo,
              fmt_undefo=fmt_undefo, interpFlag=1, endDispFlag=0,
              fmt_interp=fmt_interp, fmt_nodes=fmt_nodes, Eo=0, az_el=az_el,
              fig_wi_he=fig_wi_he, fig_lbrt=fig_lbrt):
    """Plot deformed shape of the structure.
...
This usually happens when translational DOFs are too small\n\n""")
        ...
        #                    interpFlag, endDispFlag, fmt_interp,
        #                    fmt_nodes, az_el, fig_wi_he, fig_lbrt)
        _plot_defo_mode_3d_Chen_2(specifyEle, fileName, incr_num, 0, sfac, nep, unDefoFlag, fmt_defo, fmt_undefo,
                           interpFlag, endDispFlag, fmt_interp,
                           fmt_nodes, az_el, fig_wi_he, fig_lbrt)
